 ...
 * 
 * Source:
 * http://mylifewithandroid.blogspot.nl/2010/06/plugins.html
 * 
 * Description:
 * Shows a list containing all the installed OLV plugins
 */
...
public class PluginManagerActivity extends ListActivity
{
	...
	static final String LOG_TAG = "OLV Plugin Manager";
	
	private PackageBroadcastReceiver packageBroadcastReceiver;
	private IntentFilter packageFilter;
	private ArrayList<HashMap<String,String>> services;
	private ArrayList<String> categories;
	private ArrayList<String> pluginpackagename;
	private ArrayList<String> pluginservicename;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        fillPluginList();
		/* itemAdapter = new SimpleAdapter(this, services, R.layout.services_row,
		...
		itemAdapter = new SimpleAdapter(this, services, R.layout.services_row,
		new String[] { KEY_PKG,KEY_CATEGORIES },
    ...
    {/*
		...
		String servicename = pluginservicename.get( position );
    ...
    private void fillPluginList()
    {
		...
		pluginservicename = new ArrayList<String>();
